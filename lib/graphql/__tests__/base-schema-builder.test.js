...
describe('BaseSchemaBuilder', () => {
  ...
  describe('schema generation', () => {
    ...
    it('should generate the appropriate field types', () => {
      ...
      expect(fields.someMacAddress.type).toEqual(GraphQLString)
      expect(fields.someInet.type).toEqual(GraphQLString)
      expect(fields.someCidr.type).toEqual(GraphQLString)
      expect(fields.someCitext.type).toEqual(GraphQLString)
      expect(fields.someChar.type).toEqual(GraphQLString)
      ...
      expect(fields.someInt4.type).toEqual(GraphQLString)
      ...
      expect(fields.someFloat4.type).toEqual(GraphQLString)
      ...
      expect(fields.someHStore.type).toEqual(GraphQLJSON)
      ...
      expect(fields.someIntRange.type).toEqual(GraphQLIntRange)
      expect(fields.someFloatRange.type).toEqual(GraphQLFloatRange)
      expect(fields.someDateRange.type).toEqual(GraphQLDateRange)
      expect(fields.someDateTimeRange.type).toEqual(GraphQLDateTimeRange)
